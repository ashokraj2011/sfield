...
function checkpoint(runId: string): Checkpoint {
  ...
  return {
    ...
    counters: { turns: 1, modelCalls: 1, providerAttempts: 1, toolCalls: 0, toolAttempts: 0, inputTokens: 10, outputTokens: 5, tokensReported: true, costMicroUsd: 0, costLabel: "unpriced", activeMs: 5, repairs: 0, summarizations: 0, polls: 0, contextRefits: 0, continuations: 0 },
    loop: emptyLoopState(),
    batchResults: {},
